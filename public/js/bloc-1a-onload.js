$(document).ready(function () {
  $("#linechart_simple1").css("height", 500);
  ...
  $(".embed").webuiPopover({
    ...
    content: function () {
      ...
      if (className === "vis1") {
        frameUrl =
          dir + "/vis/chapter11_1/index.html" + "?lang=" + String.locale;
        embed =
  ...
  $(".mail").click(function () {
    ...
    var url, pageDesc;
    if (className === "vis1") {
      url = "vis/chapter11_1/index.html" + "?lang=" + String.locale;
      pageDesc = _("pages.Bloc1a.infographics1");
    } else {
      url = window.location.href;
      pageDesc = _("pages.Bloc1a.title");
    }
    var link = document.createElement("a");
    link.href = url;
    var subject = _("title") + " - " + _("pages.Bloc1a.title");
    var body = pageDesc + "\r\n\r\n" + link.href;
    var mailTo =
      "mailto:?subject=" +
