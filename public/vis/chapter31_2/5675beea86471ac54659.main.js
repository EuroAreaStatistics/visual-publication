  ...
  [
    ...
    function (t, e, n) {
      ...
      function r() {
        ...
        r = Object(o.a)(r);
        if (e.params.time) r = r.replace('[yyyy-qq]', e.params.time);
        if (
          ((document.getElementById("chart_subtitle").innerHTML = r),
          !window.isSimple)
        ) {
    ...
    function (t, e, n) {
      ...
      (function (t, c) {
        ...
        function i(e) {
          ...
          return window
            ...
            .then(function (t) {
              ...
              document.getElementById("chart_subtitle").innerHTML = document.getElementById("chart_subtitle").innerHTML.replace('[yyyy-qq]', Object.keys(t.dimension.time.category.index).sort().reverse()[0]);
            })
            .catch(function (e) {
              t("#global").empty(),
                t("#global").append(
        ...
        function o(t) {
          ...
          e.params.time = c.time = o.Dimension("time").id.slice(-1)[0];
    ...
    function (t, e, n) {
      ...
      function i(t) {
        ...
        return {
          ...
          min: e.yAxisMin,
          max: e.yAxisMax,
          padding: { top: window.isSimple ? 50 : 100, bottom: 10 },
          tick: {
            format: function (t) {
              return format(t.toFixed(p).replace(/(?:(\.[^0]+)|\.)0+$/, "$1"));
            },
            values: window.isSimple && function (domain) {
              return window.d3.ticks(domain[0], domain[1], 5);
            },
          },
        };
      }
      function o(t) {
return {   height: 80,    type: "category" };
        return window.isMobile
          ? {
              padding: { right: 15552e6 },
//              type: "timeseries",
              tick: { // format: "%Y",
 outer: !1, culling: { max: 10 } },
            }
          : {
              padding: { right: 15552e6 },
//              type: "timeseries",
              tick: { culling: !1, // format: "%Y",
 outer: !1 },
            };
      }
      function a() {
        ...
        if (((n.axisRotated = !1), (n.padding = 30), window.isMobile)) {
          ...
          window.isSimple ? (n.h = null) : (n.h = 0.59 * t), (n.w = 0.9 * e);
        return n;
      }
      function f(t, e, n, jQuery) {
        var c = i(n),
          f = o(n),
          v = "#" + e,
        ...
        z.forEach(function (k) {
          d.forEach(function (o) {
            if (o[k] < c.min) delete c.min;
          });
        });
        d.forEach(function (r) { r.year = Object(s.a)('vis.label.'+r.year); });
        var H = l.bb.generate({
...
//            xFormat: h[n].xFormat,
          ...
          tooltip: {
            format: {
              title: function (x) {
                return d[x].year + ", " + h[n].params.time;
              },
                ...
                t[p] &&
                  ...
                  f === v
                    ? ((l +=
                        ...
                        m +
                        '"></span>' +
                       ('general.country.'+v).toLocaleString() +
                        "</td>"),
                      (l +=
        ...
        function (t, e) {
          ...
          function r(t, e) {
            ...
            0 === window.indicatorSelected.length &&
              ...
              (window.clicked = ""),
              Object(N.a)(s.storage.processedData[n], "linechart", n),
              Object(M.a)(),
              Object(L.a)(),
    ...
    function (t, e, n) {
      ...
      function c() {
        ...
        t.setAttribute("type", "button"),
          ...
          t.setAttribute("aria-label", Object(r.a)("close"));
        var e = document.createElement("span");
        return (
    ...
    function (t, e, n) {
      ...
      function c(t, e, n, c) {
        var i = {},
          o = [],
          a = e.Dimension("SURVEY_BRKDWN").id,
          f = !0,
          l = !1,
          s = void 0;
        try {
      ...
      function i(t, e, n, c) {
        (document.getElementById("legend-container-mobile").innerHTML = ""),
          Object(o.k)("#legend-container-mobile")
            ...
            .attr("class", "legend-block")
            .html(function (t) {
              return "EU" === t || "EA" === t ? Object(a.a)(t) : t;
            })
            .each(function (e) {
              var n = this;
      ...
      (function (t, c) {
        ...
        function u() {
          ...
          n.match(e) &&
            (t.innerHTML = n.replace(
              e,
              Object(S.a)("dropdown_countries") + ": $1"
            ));
        }
        function h() {
        ...
        function v() {
          ...
          n &&
            ...
            (n.innerHTML = Object(S.a)("dropdown_deselectall")),
        ...
        function d() {
          ...
          Object(C.a)(e, "linechart", t, c), window.isMobile ? u() : h();
        }
        function z(t) {
          var e = t[0].value;
