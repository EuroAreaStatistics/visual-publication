  ...
  [
          ...
          (t.exports = function(t, e, n, f) {
            ...
            g
              ...
              : (i(function() {
                ...
                K(b !== Function.prototype ? N(z).concat(N(b)) : N(z), function(
                  t
                ) {
                  t in m || h(m, t, z[t]);
                }),
    ...
    function(t, e, n) {
      ...
      function r() {
        ...
        if (
          ...
          var i = Object(o.a)("bookmark_link"),
            f = document.createElement("span"),
            l = document.createTextNode(Object(o.a)("bookmark_link_key"));
            f.setAttribute("class", "infolink"),
            f.appendChild(l);
    ...
    function(t, e, n) {
      ...
      function format(t) {
        ...
        return (e[0] = e[0].replace(/\B(?=(\d{3})+(?!\d))/g, Object(s.a)("thousands_separator"))), e.join(Object(s.a)("decimal_separator"));
      }
      function r(t, e) {
        var n = t['time'],
          c = window.countrySelected.filter(function (v) { return h[e].countries.indexOf(v[0]) >= 0; }),
          r = "[{}]";
        if (c.length > 0) {
          r = "[";
          var i = !0,
      ...
      function i(t) {
        ...
        return {
          ...
          label: { text: Object(s.a)(r), position: "outer-middle" },
          tick: {
            format: function(t) {
      ...
      function a() {
        ...
        if (((n.axisRotated = !1), (n.padding = 30), window.isMobile)) {
          ...
          window.isSimple ? (n.h = null) : (n.h = 0.59 * t),
            (n.w = 0.8 * e);
        return n;
      }
      function f(t, e, n, jQuery) {
        var c = i(n),
          f = o(n),
          v = "#" + e,
          m = window.countrySelected.filter(function (v) { return h[n].countries.indexOf(v[0]) >= 0; }),
          p = a(),
          d = r(t, n),
          z = [],
          b = {},
          ...
          y = !1,
          M = void 0;
        if (!window.isMobile) f.tick.values = t.time.filter(function (l) { return /^....-03/.test(l); });
        try {
          for (
        ...
        if (jQuery) {
          jQuery("#countries-desktop option").each(function () {
            jQuery(this).attr('disabled', h[n].countries.indexOf(jQuery(this).attr('value')) < 0 ? 'disabled' : null);
          });
          jQuery("#countries-desktop").selectpicker("refresh");
        }
        z.forEach(function (k) { d.forEach(function (o) { if (o[k] < c.min) delete c.min; }); });
        var H = l.bb.generate({
          ...
          tooltip: {
            format: {
             title: function(x) { return x.getFullYear()+"-"+(x.getMonth()+1).toString().padStart(2,"0"); },
          ...
          return [
            {
              ...
              children: [
                { tag: "symbol", attributes: yt({}, r, { id: o }), children: c }
              ]
            }
          ];
        },
    ...
    function(t, e, n) {
      ...
      function c(t) {
        if (window.isMobile) {
          ...
          o.innerHTML = Object(r.a)("twitter-icon");
          ...
          return (
            ...
            a.addEventListener("click", function() {
              var e = encodeURIComponent(Object(r.a)("twitter-text"));
              return (
                window.open(
        ...
        f.setAttribute("class", "fa-layers fa-2x"),
          ...
          f.setAttribute("title", Object(r.a)("twitter-icon"));
    ...
    function(t, e, n) {
      ...
      function c() {
        if (window.isMobile) {
          ...
          i.innerHTML = Object(r.a)("facebook-icon");
        ...
        a.setAttribute("class", "fa-layers fa-fw fa-2x"),
          ...
          a.setAttribute("title", Object(r.a)("facebook-icon"));
    ...
    function(t, e, n) {
      ...
      function c() {
        ...
        t.setAttribute("class", "fa-layers fa-fw fa-2x"),
          ...
          t.setAttribute("title", Object(i.a)("embed-icon"));
      ...
      function r() {
        ...
        (t.innerHTML = ""),
          t.insertBefore(
            document.createTextNode(Object(i.a)("embed_instruction")),
            t.firstChild
          );
        var e = Object(o.a)();
        t.appendChild(e);
      ...
      (function(t, c) {
        function r(t, e) {
          ...
          try {
            for (
              ...
              L[0].countries.indexOf(d[0]) < 0 && z.setAttribute("disabled", "disabled");
        ...
        function u() {
          var t = document.getElementsByClassName("filter-option pull-left")[0],
            ...
            n = t.innerHTML;
          n.match(e) &&
            (t.innerHTML = n.replace(e, Object(S.a)("dropdown_countries")+': $1'));
        }
        function h() {
