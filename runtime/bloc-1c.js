...
import { update } from "./data/bloc-1c.js";
...
document.title = _("pages.Bloc1c.title");
...
$(() => {
  update($('[data-trans-id="pages.Bloc1c.text"]'), _("pages.Bloc1c.text"));

  $("[data-trans-id]").each(function () {
    const trans = $(this).attr("data-trans-id");
    if (trans === "pages.Bloc1c.text") return;
