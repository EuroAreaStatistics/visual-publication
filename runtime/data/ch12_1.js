...
const dataSets = [
  {
    code:
      "BSI.M.AT+BE+CY+DE+EE+ES+FI+FR+GR+IE+IT+LT+LU+LV+MT+NL+PT+SI+SK+U2.N.A.L20.A.I.U2.2250.Z01.A",
    startPeriod: "2010-01",
    description:
      "Balance sheet statistics - deposits placed by households (annual growth rates)",
  },

  {
    code:
      "BSI.M.AT+BE+CY+DE+EE+ES+FI+FR+GR+IE+IT+LT+LU+LV+MT+NL+PT+SI+SK+U2.N.A.L20.A.1.U2.2250.Z01.E",
    startPeriod: "2010-01",
    description:
      "Balance sheet statistics - deposits placed by households (volumes, denominated in euro)",
  },

  {
    code:
      "BSI.M.AT+BE+CY+DE+EE+ES+FI+FR+GR+IE+IT+LT+LU+LV+MT+NL+PT+SI+SK+U2.N.A.L20.A.I.U2.2240.Z01.A",
    startPeriod: "2010-01",
    description:
      "Balance sheet statistics - deposits placed by companies (annual growth rates)",
  },

  {
    code:
      "BSI.M.AT+BE+CY+DE+EE+ES+FI+FR+GR+IE+IT+LT+LU+LV+MT+NL+PT+SI+SK+U2.N.A.L20.A.1.U2.2240.Z01.E",
    startPeriod: "2010-01",
    description:
      "Balance sheet statistics - deposits placed by companies (volumes, denominated in euro)",
  },
];
