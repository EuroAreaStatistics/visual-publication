...
const dataSets = [
  {
    code:
      "MIR.M.AT+BE+CY+DE+EE+ES+FI+FR+GR+IE+IT+LT+LU+LV+MT+NL+PT+SI+SK+U2.B.A2C.A.R.A.2250.EUR.N",
    startPeriod: "2010-01",
    description:
      "Bank interest rates - interest rates on bank loans to households for house purchase (annual percentage, new business)",
  },

  {
    code:
      "MIR.M.AT+BE+CY+DE+EE+ES+FI+FR+GR+IE+IT+LT+LU+LV+MT+NL+PT+SI+SK+U2.B.A2B.A.R.A.2250.EUR.N",
    startPeriod: "2010-01",
    description:
      "Bank interest rates - interest rates on bank loans to households for consumption (annual percentage, new business)",
  },

  {
    code:
      "MIR.M.AT+BE+CY+DE+EE+ES+FI+FR+GR+IE+IT+LT+LU+LV+MT+NL+PT+SI+SK+U2.B.A2Z.A.R.A.2250.EUR.N",
    startPeriod: "2010-01",
    description:
      "Bank interest rates - interest rates on bank loans to households for revolving loans and overdrafts (annual percentage, new business)",
  },

  {
    code:
      "MIR.M.AT+BE+CY+DE+EE+ES+FI+FR+GR+IE+IT+LT+LU+LV+MT+NL+PT+SI+SK+U2.B.A2D.A.R.A.2250.EUR.N",
    startPeriod: "2010-01",
    description:
      "Bank interest rates - interest rates on bank loans to households for other purposes (annual percentage, new business)",
  },
];
