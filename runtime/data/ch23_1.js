...
const dataSets = [
  {
    code:
      "MIR.M.AT+BE+CY+DE+EE+ES+FI+FR+GR+IE+IT+LT+LU+LV+MT+NL+PT+SI+SK+U2.B.A2I.AM.R.A.2240.EUR.N",
    startPeriod: "2010-01",
    description:
      "Bank interest rates - total interest rates for companies (annual percentage, new business)",
  },

  {
    code:
      "BSI.M.AT+BE+CY+DE+EE+ES+FI+FR+GR+IE+IT+LT+LU+LV+MT+NL+PT+SI+SK+U2.N.A.A20T.A.I.U2.2240.Z01.A",
    startPeriod: "2010-01",
    description:
      "Balance sheet statistics - bank loans to companies - (annual growth rates)",
  },

  {
    code:
      "BSI.M.AT+BE+CY+DE+EE+ES+FI+FR+GR+IE+IT+LT+LU+LV+MT+NL+PT+SI+SK+U2.N.A.A20T.A.1.U2.2240.Z01.E",
    startPeriod: "2010-01",
    description:
      "Balance sheet statistics -  bank loans to companies (outstandings, volumes, denominated in euro)",
  },
];
