...
update(
  $("#chart-subtitle"),
  _("vis.unit").replace("[yyyy-mm]", "[Date 3]"),
  "../../"
);
  ...
  $("#bookmark-link")
    ...
    .append(
      ...
      $('<span class="infolink">')
        ...
        .on("click", function () {
          window.location =
            "https://www.euro-area-statistics.org/data?project=dp-inflation-c-1-2-1";
        })
    );
  ...
  $("#linechart")
    ...
    .append(
      $('<iframe frameborder="0">').attr(
        "src",
        "https://www.euro-area-statistics.org/dp-inflation-c-1-2-1?cr=oecd&lg=" +
          String.locale +
